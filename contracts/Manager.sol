...
contract Manager is IManager {
    ...
    function createPair(
        ...
        //bind TradeToken
        TradeToken tradeToken = new TradeToken(market, strConcat("YFX:", _lpTokenName), IMaker(maker).getChainId());
        ...
        IMarket(market).initialize(_indexPrice, _clearAnchor, _ratio, maker, _marketType, address(tradeToken));
        IMaker(maker).initialize(_indexPrice, _clearAnchor, market, _marketType, strConcat("LP:", _lpTokenName));
